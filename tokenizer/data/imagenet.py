...
import sys
sys.path.append(".")
from tokenizer.data.base import ImagePaths
from tokenizer.util import download, retrieve
import tokenizer.data.utils as bdu
...
class ImageNetBase(Dataset):
    ...
    def _load(self):
        ...
        self.data = ImagePaths(self.abspaths,
                               ...
                               random_crop=self.random_crop, flip=self.random_flip)
